...
function LoginPage() {
    ...
    const handleSubmit = async (e) => {
        ...
        try {
            ...
            if (response.statusCode === 200) {
                // Token and role save karo
                localStorage.setItem('token', response.token || '');
                localStorage.setItem('role', response.role || 'USER'); // default role agar na aaye to 'USER'
            ...
            // Backend ya network error show karo
    ...
    return (
        <div className="flex items-center justify-center min-h-screen bg-gradient-to-br from-blue-100 to-indigo-200 pt-16">
